    ...
    if (context.theme === "light") {
        mode = (
            <Fragment>
                ...
                Dark Mode
                <Link to="/login" style= {{ textDecoration: 'underline', padding: '0 0 0 10px' }}>Logout</Link>
            </Fragment>
        );
        ...
        mode = (
            <Fragment>
                ...
                Light Mode
                <Link to="/login" style= {{ color: 'white', textDecoration: 'underline', padding: '0 0 0 10px' }}>Logout</Link>
            </Fragment>
        );
    }
